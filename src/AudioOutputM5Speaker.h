/* 
  ...
  M5UnifiedでESP8266Audioを使うための AudioOutput を継承したクラス
  robo8080さんのAIスタックチャンのAudioOutputM5Speaker.hをほぼそのまま使用させていただきました。
 
  robo8080さん版 (MIT LICENSE)
  https://github.com/robo8080/AI_StackChan2/blob/main/M5Unified_AI_StackChan/src/AudioOutputM5Speaker.h
...
*/
#pragma once
#include <AudioOutput.h>  // ESP866Audioが必要
